use cpython::{ToPyObject, Python, PyDict};
use std::fs::File;
use rosu_pp::{Beatmap, TaikoPP, BeatmapExt};
...
pub(crate) fn calculate_taiko_pp(map: String, mods: u32, combo: Option<usize>, acc: Option<f32>, n300: Option<usize>,
